...
class BcaHttp
{
    ...
    public function userUpdate(
        ...
        if ($param['customerName'] != '') {
            $bodyData['CustomerName'] = $param['customerName'];
        }
        if ($param['dateOfBirth'] != '') {
            $bodyData['DateOfBirth'] = $param['dateOfBirth'];
        }
        if ($param['mobileNumber'] != '') {
            $bodyData['MobileNumber'] = $param['mobileNumber'];
        }
        if ($param['emailAddress'] != '') {
            $bodyData['EmailAddress'] = $param['emailAddress'];
        }
        if ($param['walletStatus'] != '') {
            $bodyData['WalletStatus'] = $param['walletStatus'];
        }
     ...
     */
    public function transfersInquiry(
        $oauth_token,
        $primaryID,
        $transactionID,
        $requestDate
